...
namespace Couchbase
{
    class Couchbase extends \Memcached
    {
         ...
         * @return bool
         */
        public function addCouchbaseServer($host, $port = 11211, $couchport = 5984, $internal_host = null, $internal_port = 8091 )
        {
            ...
            $this->couchdb = new CouchDB("http://$host:$couchport/{$this->default_bucket_name}");
            $this->couchbase = new Internal("http://$internal_host:$internal_port/");
            $this->_readDesignDocs();
            return parent::addServer($host, $port);
        }

        /**
         * @param ViewDefinition $view_definition
         * @return bool
         */
        function addView(ViewDefinition $view_definition)
        {
         ...
         *
         * @return View instance ready for querying
         */
        ...
        function touch($key, $expire = 0)
        {
            ...
            return parent::touch($key, $expire);
        }
            ...
            foreach ($ddocs->rows AS $ddoc_row) {
                ...
                if (isset($ddoc->views)) {
                    foreach ($ddoc->views AS $view_name => $definition) {
                        $view = new View($ddoc_name, $view_name);
